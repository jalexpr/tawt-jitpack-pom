...
public class Test {
    public static void main(String[] args) {
        ...
        List<BearingPhraseExt> phraseExts1
                = sp.getTreeSentenceWithoutAmbiguity("Давно замечено, что каждый художник в творчестве своем " +
        ...
        List<BearingPhraseExt> phraseExts2
                = sp.getTreeSentenceWithoutAmbiguity("Ребенком не только в отношении своем к \"добру\", а во всех " +
        ...
        List<BearingPhraseExt> phraseExts3
                = sp.getTreeSentenceWithoutAmbiguity("\"- Нет, знаешь, я не верю этому, чтобы мы были в животных, " +
        ...
        List<BearingPhraseExt> phraseExts4
                = sp.getTreeSentenceWithoutAmbiguity("— Нет, знаешь, я не верю этому, чтобы мы были в животных," +
        ...
        List<BearingPhraseExt> phraseExts5
                = sp.getTreeSentenceWithoutAmbiguity("лёгок, лёгкий");
